...
public class comidaProvider {
    ...
    public static boolean guardarComida (String coleccion, String documento,
    ...
    public static boolean actualizarComida (String coleccion, String documento,
            Map<String, Object> data){
    ...
    public static void cargarTabalaLibro(JTable table){
    ...
    public static void eliminarComida(String comida, String string) {
        throw new UnsupportedOperationException("Not supported yet."); // Generated from nbfs://nbhost/SystemFileSystem/Templates/Classes/Code/GeneratedMethodBody
    }
}
